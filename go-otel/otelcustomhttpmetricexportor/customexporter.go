...
package otelcustomhttpmetricexportor // import "go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp"
...
import (
	...
	"rai-go-otel/otelcustomhttpmetricexportor/global"
	"rai-go-otel/otelcustomhttpmetricexportor/internal/oconf"
	"rai-go-otel/otelcustomhttpmetricexportor/internal/transform"
...
func (e *Exporter) UpdateClientHeader(key string, value []string) {
	convertedClient := e.client.(*client)
	convertedClient.req.Header[key] = value
}
